# Generated by Django 4.0 on 2023-11-22 09:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('captain', models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='clubs_set2', to='football.users')),
                ('creator', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='clubs_set1', to='football.users')),
            ],
            options={
                'db_table': 'fb_clubs',
                'ordering': ('id',),
